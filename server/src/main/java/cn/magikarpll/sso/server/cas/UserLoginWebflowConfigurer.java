...
public class UserLoginWebflowConfigurer extends DefaultLoginWebflowConfigurer {
    /**
     ...
     */
    public UserLoginWebflowConfigurer(FlowBuilderServices flowBuilderServices, FlowDefinitionRegistry flowDefinitionRegistry, ConfigurableApplicationContext applicationContext, CasConfigurationProperties casProperties) {
    ...
    protected void bindCredential(Flow flow) {
        //重写绑定自定义credential
        createFlowVariable(flow, CasWebflowConstants.VAR_ID_CREDENTIAL, UserLoginCredentials.class);
        //登录页绑定新参数
        final ViewState state = (ViewState) flow.getState(CasWebflowConstants.STATE_ID_VIEW_LOGIN_FORM);
        final BinderConfiguration cfg = getViewStateBinderConfiguration(state);
        //对新加系统参数绑定
        cfg.addBinding(new BinderConfiguration.Binding("account", null, true));
        cfg.addBinding(new BinderConfiguration.Binding("password", null, true));
        cfg.addBinding(new BinderConfiguration.Binding("text", null, false));
        ...
        cfg.addBinding(new BinderConfiguration.Binding("receiverType", null, true));
        cfg.addBinding(new BinderConfiguration.Binding("appSourceId", null, true));
    }
    ...
    protected void createLoginFormView(final Flow flow) {
        ...
        propertiesToBind.add("account");
        propertiesToBind.add("password");
        propertiesToBind.add("text");
        propertiesToBind.add("code");
        propertiesToBind.add("loginType");
        propertiesToBind.add("receiverType");
        propertiesToBind.add("appSourceId");
        ...
        createStateModelBinding(state, CasWebflowConstants.VAR_ID_CREDENTIAL, UserLoginCredentials.class);
